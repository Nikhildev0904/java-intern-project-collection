...
public class Comparison {
    ...
    public void compareAll(List<String> lines) throws InterruptedException, ExecutionException {
        ...
        Map<String, Integer> SyncRunnableWordCount = syncRunnableThread.getWordCount(lines);
        end = System.currentTimeMillis();
        ...
        Map<String, Integer> callableThreadWordCount = callableThread.getWordCount(lines);
        end = System.currentTimeMillis();
        ...
        Map<String, Integer> runnableThreadPoolWordCount = runnableThreadPool.getWordCount(lines);
        end = System.currentTimeMillis();
        ...
        Map<String, Integer> callableThreadPoolWordCount = callableThreadPool.getWordCount(lines);
        end = System.currentTimeMillis();
        ...
        Map<String, Integer> completableFutureWordCount = completableFuture.getWordCount(lines);
        end = System.currentTimeMillis();
        ...
        Map<String, Integer> forkJoinActionWordCount = forkJoin.getWordCountWithForkJoinAction(lines);
        end = System.currentTimeMillis();
        ...
        start = System.currentTimeMillis();
        Map<String, Integer> forkJoinTaskWordCount = forkJoin.getWordCountWithForkJoinTask(lines);
        end = System.currentTimeMillis();
